/*
 ...
 Check link for algorithm example.
 */
...
BinaryHeap.prototype = {
    ...
    bubbleUp: function(n) {
        // Fetch the element that has to be moved up.
        var element = this.content[n],
            score = this.scoreFunction(element);

        // When at 0, the element cannot go any further
        while(n>0) {
            // Computer the parent element's index and fetch it.
